  ...
  return (
    <div className="rounded-lg border border-warning/30 bg-warning/5 p-4">
      ...
      <textarea
        ...
        rows={2}
        className="mt-3 w-full rounded-md border border-border bg-secondary p-2.5 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring resize-none"
      />
      <button
        onClick={handleSubmit}
        disabled={submitMutation.isPending}
        className="mt-2 rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90 transition-colors disabled:opacity-50"
      >
